...
public abstract class AutoWithIMU extends LinearOpMode {
    
    static final double     COUNTS_PER_MOTOR_REV    = 1440 ;    // eg: TETRIX Motor Encoder
    static final double     DRIVE_GEAR_REDUCTION    = 1.0 / 7.0 ;     // This is < 1.0 if geared UP
    static final double     WHEEL_DIAMETER_INCHES   = 9 / 2.51;     // For figuring circumference
    ...
    protected final HardwareWobblySquare2 hardware = new HardwareWobblySquare2();
    ...
    public void runOpMode() throws InterruptedException {
        ...
        /*while (!isStopRequested() && !hardware.imu.isSystemCalibrated())  {
            sleep(50);
            idle();
        }*/
        ...
        while (!isStarted()) {
            telemetry.addData(">", "Robot Heading = %d", (int)hardware.imu.getAngularOrientation(AxesReference.EXTRINSIC, AxesOrder.XYZ, AngleUnit.DEGREES).thirdAngle);
            telemetry.update();
        }
    }
    ...
    public void gyroDrive ( double speed,
        ...
        if (opModeIsActive()) {
            ...
            newLeftTarget = hardware.leftMotor.getCurrentPosition() + moveCounts;
            newRightTarget = hardware.rightMotor.getCurrentPosition() + moveCounts;
            ...
            while (opModeIsActive() &&
                    (hardware.rightMotor.isBusy() && hardware.rightMotor.isBusy())
            ) {
                ...
                hardware.leftMotor.setPower(-leftSpeed);
                hardware.rightMotor.setPower(rightSpeed);

                // Display drive status for the driver.
                telemetry.addData("Err/St",  "%5.1f/%5.1f",  error, steer);
                telemetry.addData("Target",  "%7d:%7d",      newLeftTarget,  newRightTarget);
                telemetry.addData("Actual",  "%7d:%7d",      hardware.leftMotor.getCurrentPosition(),
    ...
    public double getError(double targetAngle) {
        ...
        robotError = targetAngle - hardware.imu.getAngularOrientation(AxesReference.EXTRINSIC, AxesOrder.XYZ, AngleUnit.DEGREES).thirdAngle;
